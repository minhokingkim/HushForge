 ...
 * This file demonstrates how to integrate Hushforge with a web frontend
 */

// For React/Vue/Angular applications
export class HushforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HushforgeClient(provider, contractAddress);
